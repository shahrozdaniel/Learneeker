    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="fade-up">
          <h1>It's just like regular class</h1>
          <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aut iure saepe accusantium expedita, a quod, modi
            delectus libero non porro eligendi quia reprehenderit sequi sint. Laboriosam illum voluptas quibusdam quae?
          </p>
          <div class="d-flex">
            <a href="index.html#about" class="btn-get-started">Book a Demo</a>
      ...
      <div class="row gy-4">
        ...
        <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="100">
          <div class="service-item position-relative">
            ...
            <h4><a href="{{ route('course.details', 'Maths') }}" class="stretched-link">Maths</a></h4>
        ...
        <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="200">
          <div class="service-item position-relative">
            ...
            <h4><a href="{{ route('course.details', 'Coding') }}" class="stretched-link">Coding</a></h4>
        ...
        <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="300">
          <div class="service-item position-relative">
            ...
            <h4><a href="{{ route('course.details', 'English') }}" class="stretched-link">English</a></h4>
        ...
        <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="400">
          <div class="service-item position-relative">
            ...
            <h4><a href="{{ route('course.details', 'Science') }}" class="stretched-link">Science</a></h4>
